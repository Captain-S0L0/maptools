package xyz.terriblefriends.maptools.nbt;
...
public class NBTTagCompound extends NBTBase
{
    ...
    public byte[] getByteArray(String key)
    {
        ...
        {
            this.createCrashReport(key, 7, classcastexception);
        }
    ...
    public int[] getIntArray(String key)
    {
        ...
        {
            this.createCrashReport(key, 11, classcastexception);
        }
    ...
    public NBTTagCompound getCompoundTag(String key)
    {
        ...
        {
            this.createCrashReport(key, 10, classcastexception);
        }
    ...
    public NBTTagList getTagList(String key, int type)
    {
        ...
        {
            this.createCrashReport(key, 9, classcastexception);
        }
     ...
     */
    private void createCrashReport(final String key, final int expectedType, ClassCastException ex)
    {
        System.out.println("Tag type expected: "+NBTBase.NBT_TYPES[expectedType]);
        System.out.println("Tag type found: "+NBTBase.NBT_TYPES[(NBTTagCompound.this.tagMap.get(key)).getId()]);
        throw new RuntimeException("Error Reading NBT data");
    }
