...
public class NBTTagList extends NBTBase
{
    ...
    public void appendTag(NBTBase nbt)
    {
        if (nbt.getId() == 0)
        {
            System.out.println("Invalid TagEnd added to ListTag");
        }
        else
        {
            if (this.tagType == 0)
            ...
            {
                System.out.println("Adding mismatching tag types to tag list");
                return;
            }
    ...
    public void set(int idx, NBTBase nbt)
    {
        ...
        {
            System.out.println("index out of bounds to set tag in tag list");
        }
    }
    ...
    public int getShortAt(int p_186858_1_)
    {
